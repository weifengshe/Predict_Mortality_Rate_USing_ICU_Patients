...
writeOutput(uofirstday,uri,folder,"UOFIRSTDAY_1")
...
""")
writeOutput(ventdurations,uri,folder,"VENTDURATIONS_1")
...
""")
writeOutput(ventfirstday,uri,folder,"VENTFIRSTDAY_1")
...
writeOutput(vitalsfirstday,uri,folder,"VITALSFIRSTDAY_1")
...
writeOutput(rrtfirstday,uri,folder,"RRTFIRSTDAY_1")
...
writeOutput(rrt,uri,folder,"RTT_1")
...
writeOutput(labsfirstday,uri,folder,"LABSFIRSTDAY_1")
...
writeOutput(echodata,uri,folder,"ECHODATA_1")
...
writeOutput(gcsfirstday,uri,folder,"GCSFIRSTDAY_1")
...
writeOutput(bloodgasfirstday,uri,folder,"BLOODGASFIRSTDAY_1")
...
writeOutput(bloodgasfirstdayarterial,uri,folder,"BLOODGASFIRSTDAYARTERIAL_1")
...
writeOutput(oasis,uri,folder,"OASIS_1")
...
writeOutput(sapsii,uri,folder,"SAPSII_1")
...
writeOutput(sofa,uri,folder,"SOFA_1")
